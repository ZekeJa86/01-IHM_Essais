<template>
<div class="min-h-screen flex flex-col isolate bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 px-6 py-24 sm:py-20 lg:px-8">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <form @submit.prevent="handleSubmit" class="mx-auto mt-10 max-w-xl sm:mt-5 w-full">
